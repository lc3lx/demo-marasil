...
export function PremiumMobileNav() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-20 border-t bg-white/80 backdrop-blur-md md:hidden">
      <div className="grid grid-cols-5">
        ...
        <Link href="/create-shipment" className="flex flex-col items-center justify-center py-2 text-white">
          <div className="flex h-14 w-14 items-center justify-center rounded-full primary-gradient shadow-lg">
