...
export function ModernPricingTable() {
  return (
    <Tabs defaultValue="domestic" className="w-full">
      <TabsList className="grid w-full max-w-md grid-cols-2 rounded-xl clay-morphism border-none">
      ...
      <TabsContent value="domestic" className="mt-4">
        <div className="rounded-xl clay-morphism overflow-hidden">
          ...
          <div className="divide-y">
            {[
              ...
              <div key={i} className="grid grid-cols-4 gap-4 p-4 hover:bg-white/50 transition-colors">
                <div>{route.from}</div>
                <div>{route.to}</div>
        ...
        <Button variant="outline" className="mt-4 w-full rounded-xl clay-button">
          عرض جميع الأسعار
        </Button>
      </TabsContent>
