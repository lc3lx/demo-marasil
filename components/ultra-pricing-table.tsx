...
export function UltraPricingTable() {
  return (
    <Tabs defaultValue="domestic" className="w-full">
      <TabsList className="grid w-full max-w-md grid-cols-2 rounded-xl glass-morphism border-none">
      ...
      <TabsContent value="domestic" className="mt-4">
        ...
        <Button variant="outline" className="mt-4 w-full rounded-xl glass-morphism border-none">
          عرض جميع الأسعار
        </Button>
      </TabsContent>
