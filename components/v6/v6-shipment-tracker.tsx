...
export function V6ShipmentTracker() {
    ...
    <div className="space-y-4">
      <div className="flex gap-2">
        <input
          ...
          className="v6-input flex-1 v6-clay border-none"
        />
        <Button onClick={handleTrack} className="v6-gradient-primary v6-button" disabled={isLoading}>
          {isLoading ? (
            <div className="flex space-x-1">
              <div className="v6-loading-dot h-2 w-2 rounded-full bg-white"></div>
              <div className="v6-loading-dot h-2 w-2 rounded-full bg-white"></div>
              <div className="v6-loading-dot h-2 w-2 rounded-full bg-white"></div>
            </div>
          ) : (
      ...
      {isTracking && (
        <div className="mt-4 rounded-xl v6-clay p-4 v6-fade-in">
          <div className="mb-3 flex items-center justify-between">
            <div className="font-medium">شحنة #1001</div>
            <div className="v6-badge v6-badge-warning">جاري التوصيل</div>
          </div>
          ...
          <div className="relative space-y-0">
            ...
            <div className="relative flex items-center gap-3 pb-6">
              <div className="z-10 flex h-8 w-8 items-center justify-center rounded-full v6-gradient-success">
            ...
            <div className="relative flex items-center gap-3 pb-6">
              <div className="z-10 flex h-8 w-8 items-center justify-center rounded-full v6-gradient-warning v6-pulse">
