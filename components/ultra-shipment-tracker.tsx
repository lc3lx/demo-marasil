...
export function UltraShipmentTracker() {
    ...
    <div className="space-y-4">
      <div className="flex gap-2">
        <input
          ...
          className="luxury-input flex-1 glass-morphism border-none"
        />
        <Button onClick={handleTrack} className="luxury-primary luxury-button">
          <Search className="h-4 w-4" />
        </Button>
      </div>

      {isTracking && (
        <div className="mt-4 rounded-xl glass-morphism p-4">
          <div className="mb-3 flex items-center justify-between">
            <div className="font-medium">شحنة #1001</div>
            <div className="status-badge-luxury status-badge-warning">جاري التوصيل</div>
          </div>
          ...
          <div className="relative space-y-0">
            ...
            <div className="relative flex items-center gap-3 pb-6">
              <div className="z-10 flex h-8 w-8 items-center justify-center rounded-full luxury-success">
            ...
            <div className="relative flex items-center gap-3 pb-6">
              <div className="z-10 flex h-8 w-8 items-center justify-center rounded-full luxury-warning pulse-luxury">
