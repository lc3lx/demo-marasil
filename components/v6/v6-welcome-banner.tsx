...
export function V6WelcomeBanner() {
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-3xl v6-morphing p-6 text-white shadow-lg md:p-8 transition-all duration-1000 ${isAnimated ? "opacity-100" : "opacity-0 translate-y-10"}`}
    >
      ...
      <div className="relative z-10 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        ...
        <div className="flex flex-wrap gap-3">
          <Button className="v6-button bg-white/20 hover:bg-white/30 gap-2">
            <TrendingUp className="h-5 w-5" />
            <span>تقرير الأداء</span>
          </Button>
          <Button className="v6-button bg-white text-primary hover:bg-white/90 gap-2">
